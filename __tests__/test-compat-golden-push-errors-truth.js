...
const cases = [
  [
    '[remote rejected] main -> main (non-fast-forward) (hint: Updates were rejected because...)',
    'ENONFASTFORWARD',
  ],
  [
    'remote: error: GH006: Protected branch update failed for refs/heads/main. hook declined',
    'EPERM',
  ],
  [
    '! [rejected]  v1.2.3 -> v1.2.3 (cannot lock ref refs/tags/v1.2.3: is at abcdef0 but expected 1234567)',
    'ECONFLICT',
  ],
  ['fatal: Authentication failed for https://example.com/repo.git', 'EAUTH'],
  [
    '! [remote rejected] feature -> feature (shallow update not allowed)',
    'EUNSUPPORTED',
  ],
]
